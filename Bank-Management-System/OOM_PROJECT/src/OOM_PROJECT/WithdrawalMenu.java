...
// TODO add your handling code here:
        ...
        try{
            ...
            int result = JOptionPane.showConfirmDialog(this,"Withdrawal Rs"+ amount + " from the account?\nTransaction Fee: Rs" + String.format("%.2f",customer.getAccount().getTransactionFee()));
            if(result==JOptionPane.OK_OPTION){
            customer.getAccount().Withdraw(amount,this);
            this.dispose();}
